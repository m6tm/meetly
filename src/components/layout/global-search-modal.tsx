...
const allSearchItems: SearchItem[] = [
	...
	},
	{
		...
		icon: Clapperboard,
		keywords: ["videos", "playbacks", "archives"],
	},
	{
		id: "transcriptions",
	...
	},
	{
		...
		icon: Settings,
		keywords: ["configuration", "profile", "preferences"],
	},
];
				...
				(item) =>
					...
					(item.keywords &&
						item.keywords.some((kw) =>
							kw.toLowerCase().includes(lowerSearchTerm),
						)),
			);
