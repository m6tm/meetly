...
export default function AccountComponent() {
	...
	const [closeAccountConfirmationText, setCloseAccountConfirmationText] =
		React.useState("");
				...
				<CardContent className="space-y-6">
					...
					<div className="space-y-2">
						...
						<p className="text-sm text-muted-foreground">
							Your next bill is on August 1, 2024 for $19.99.
						</p>
						<Link
					...
					<div className="space-y-2">
						...
						<AlertDialog
							open={isCloseAccountDialogOpen}
							onOpenChange={setIsCloseAccountDialogOpen}
						>
							...
							<AlertDialogContent>
								<AlertDialogHeader>
									...
									<AlertDialogDescription>
										...
										votre compte et toutes vos données. Pour confirmer, veuillez
										taper "
								...
								<div className="py-4">
									<Label
										htmlFor="close-account-confirm-input"
										className="sr-only"
									>
									...
									<Input
										...
										onChange={(e) =>
											setCloseAccountConfirmationText(e.target.value)
										}
										placeholder={confirmationPhrase}
										className={
											closeAccountConfirmationText !== "" &&
											closeAccountConfirmationText !== confirmationPhrase
								...
								<AlertDialogFooter>
									...
									>
										...
										{isClosingAccount
											? "Fermeture..."
											: "Je comprends, fermer mon compte"}
									</AlertDialogAction>
								</AlertDialogFooter>
							</AlertDialogContent>
						</AlertDialog>
