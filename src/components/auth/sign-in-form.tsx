...
export default function SignInForm() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (signInError) {
      ...
      // Cas où data.user est null mais il n'y a pas d'erreur explicite
    ...
    <Card className="w-full max-w-md shadow-xl">
      ...
      <div className="px-6 pb-6">
        ...
        <div className="grid grid-cols-1 gap-3">
          <Button variant="outline" className="w-full" onClick={() => console.log('Google Sign In clicked')} disabled={isLoading}>
            <GoogleIcon /> <span className="ml-2">Sign in with Google</span>
          </Button>
          <Button variant="outline" className="w-full" onClick={() => console.log('Facebook Sign In clicked')} disabled={isLoading}>
            <FacebookIcon /> <span className="ml-2">Sign in with Facebook</span>
          </Button>
          <Button variant="outline" className="w-full" onClick={() => console.log('GitHub Sign In clicked')} disabled={isLoading}>
