...
export const closeAccountAction = async (): Promise<
...
// Appearance
export const getAppearanceAction = async (): Promise<
	ActionResponse<Appearance>
> => {
	const supabase = await createClient();
	const {
		data: { user },
...
export const updateAppearanceAction = async (
	payload: UpdateAppearancePayload,
): Promise<ActionResponse<Appearance>> => {
