...
import type { ParticipantMetadata } from "@/types/meetly.types";
...
export function getParticipantMetadata(
	...
	const metadata = JSON.parse(
		participant.metadata ?? JSON.stringify(defaultMetadata),
	);
	return metadata as ParticipantMetadata;
}

export function setParticimantMetadata(
	participant: LocalParticipant,
	newMetadata: ParticipantMetadata,
) {
